...
const selPi = document.getElementById("selPi");
const selThick = document.getElementById("selThick");
...
selPi.addEventListener("click", inPi);
selThick.addEventListener("click", inThick);
